                ...
                data.forEach(item => {
                    ...
                    let item_info = `<div class="col-lg-2 box ${item.category}"
                            ...
                            <div id="image"><img src="${item.img == "" ? "./assets/images/default.jpg" : img_path + item.img}" id="product_img" alt=""></div>                    
                                        ...
                                        <div>
                                        <span class="stock">STOCK </span><span class="count">${item.stock == 1 ? item.quantity : ' 0'}</span></div>
                                        <sp class="text-dark text-center"><b data-plugin="counterup">${settings.symbol + item.price}</b> </sp>
                            </div>
                                        </div>
                        </div>`;
...
function authenticate() {
    $('#loading').append(
        `<div style="background-color: white;display:flex;justify-content:center;align-items:center;flex-direction:column">
            ...
            <path d="M125.012 80.5C125.012 89.3036 122.401 97.9095 117.51 105.229C112.619 112.549 105.667 118.255 97.5339 121.623C89.4004 124.992 80.4506 125.874 71.8162 124.156C63.1817 122.439 55.2505 118.2 49.0254 111.975C42.8003 105.749 38.561 97.8182 36.8435 89.1838C35.126 80.5494 36.0075 71.5995 39.3765 63.4661C42.7455 55.3326 48.4507 48.3808 55.7706 43.4898C63.0905 38.5988 71.6964 35.9882 80.5 35.9882L80.5 45.7684C73.6307 45.7684 66.9157 47.8054 61.2042 51.6218C55.4926 55.4381 51.041 60.8624 48.4122 67.2088C45.7835 73.5552 45.0957 80.5385 46.4358 87.2758C47.7759 94.013 51.0838 100.202 55.9411 105.059C60.7984 109.916 66.9869 113.224 73.7242 114.564C80.4615 115.904 87.4448 115.216 93.7912 112.588C100.138 109.959 105.562 105.507 109.378 99.7958C113.195 94.0842 115.232 87.3692 115.232 80.5H125.012Z" fill="#112B3C"/>
            <path d="M50.5098 132.445C36.7333 124.491 26.6806 111.39 22.5634 96.0241C18.4462 80.6583 20.6016 64.2864 28.5554 50.5098C36.5093 36.7333 49.6102 26.6806 64.9759 22.5634C80.3416 18.4461 96.7136 20.6015 110.49 28.5554L103.901 39.9688C93.1511 33.7626 80.3764 32.0807 68.3869 35.2933C56.3973 38.5059 46.1751 46.3498 39.9688 57.0993C33.7626 67.8488 32.0808 80.6235 35.2933 92.6131C38.5059 104.603 46.3498 114.825 57.0993 121.031L50.5098 132.445Z" fill="#112B3C "/>
            <path d="M80.5 0C101.85 2.54595e-07 122.325 8.48122 137.422 23.5779C152.519 38.6746 161 59.1501 161 80.5L143.312 80.5C143.312 63.8411 136.695 47.8645 124.915 36.0849C113.135 24.3053 97.1589 17.6876 80.5 17.6876L80.5 0Z" fill="#112B3C "/>
            </svg>
            </span>
                <form id="account" class="form-group">
                    ...
                    <div>
                        <input type="submit" style="background-color: #112B3C ; width: 418px ; height: 38px; " value="Login to Dashboard">
                    </div>
                </form>
            </div>
        </div>`
